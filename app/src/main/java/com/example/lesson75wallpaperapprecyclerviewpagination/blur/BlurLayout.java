package com.example.lesson75wallpaperapprecyclerviewpagination.blur;
...
public class BlurLayout extends FrameLayout {
     ...
     */
    private Bitmap getDownscaledBitmapForView(View view, Rect crop, float downscaleFactor) throws com.example.lesson75wallpaperapprecyclerviewpagination.blur.BlurKitException, NullPointerException {
        ...
        if (screenView.getWidth() <= 0 || screenView.getHeight() <= 0 || width <= 0 || height <= 0) {
            throw new com.example.lesson75wallpaperapprecyclerviewpagination.blur.BlurKitException("No screen available (width or height = 0)");
        }
